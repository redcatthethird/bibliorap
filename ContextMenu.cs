...
namespace BiblioRap
{
	...
	/// </summary>
	/// <example>
	///    ShellC_ontextMenu scm = new ContextMenu();
	...
	public class ContextMenu : NativeWindow
	{
		...
		private IShellFolder GetDesktopFolder()
		{
			...
			if (null == _oDesktopFolder)
			{
				...
				if (S_OK != nResult)
				{
					throw new ContextMenuException("Failed to get the desktop shell folder");
				}
	...
	public class ContextMenuException : Exception
	{
		...
		public ContextMenuException(string message)
			: base(message)
		{
		}
	}
